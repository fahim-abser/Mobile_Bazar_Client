...
const AddProducts = () => {
    ...
    const HandleSubmitProducts = (event) => {
        ...
        console.log(details)
        fetch('https://assaingment-twelve-server.vercel.app/addProducts', {
            method: 'POST',
            headers: {
    ...
    return (
        <form onSubmit={HandleSubmitProducts} className='bg-blue-100'>
            <div className='mt-20 ml-6'>
                ...
                <textarea name='condition' id="message" rows="4" className="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Mobile condition"></textarea>
